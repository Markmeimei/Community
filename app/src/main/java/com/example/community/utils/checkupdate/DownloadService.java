...
public class DownloadService extends Service {
    ...
    // 返回的安装包url
	/* 下载包安装路径 */
    private static final String savePath = "/sdcard/Community/";

    private static final String saveFileName = savePath + "AppUpdate.apk";
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    Comm_Application.setIsDownload(false);
                    // 下载完毕
                    // 取消通知
...
//                        mNotification
//                                .setLatestEventInfo(mContext, "下载完成",
//                                "文件已下载完毕", contentIntent);
    ...
    private void setUpNotification() {
        ...
        contentView.setTextViewText(R.id.name, "社区警务平台.apk 正在下载...");
        // 指定个性化视图
    ...
    private Runnable mdownApkRunnable = new Runnable() {
        ...
        public void run() {
            try {
                URL url = new URL(ToolUtils.apkUrl);
