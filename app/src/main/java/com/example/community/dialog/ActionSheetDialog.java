...
public class ActionSheetDialog {
    ...
    public ActionSheetDialog builder(){
        // 获取布局
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_alert_sheet,null);
        // 设置Dialog 最小宽度为屏幕宽度
    ...
    private void setSheetItems(){
        ...
        // 添加条目过多的时候控制高度
        if(size >= 7){
            LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) sLayout_content.getLayoutParams();
            layoutParams.height = display.getHeight()/2;
            sLayout_content.setLayoutParams(layoutParams);
        }
        // 循环添加条目
